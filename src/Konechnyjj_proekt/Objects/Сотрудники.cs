...
namespace IIS.Konechnyjj_proekt
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Konechnyjj_proekt.Отделы fОтделы;
        
        private IIS.Konechnyjj_proekt.Должности fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Konechnyjj_proekt.Должности Должности
        {
            get
            {
                ...
                IIS.Konechnyjj_proekt.Должности result = this.fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Отделы"})]
        [NotNull()]
        public virtual IIS.Konechnyjj_proekt.Отделы Отделы
        {
            get
            {
                ...
                IIS.Konechnyjj_proekt.Отделы result = this.fОтделы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Konechnyjj_proekt.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Konechnyjj_proekt.Сотрудники));
                }
            }
        }
    }
